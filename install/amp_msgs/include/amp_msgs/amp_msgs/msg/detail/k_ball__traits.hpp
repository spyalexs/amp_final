...
#ifndef AMP_MSGS__MSG__DETAIL__K_BALL__TRAITS_HPP_
#define AMP_MSGS__MSG__DETAIL__K_BALL__TRAITS_HPP_
...
inline std::string to_yaml(const KBall & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const amp_msgs::msg::KBall & msg)
{
  return amp_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<amp_msgs::msg::KBall>()
{
  return "amp_msgs::msg::KBall";
}

template<>
inline const char * name<amp_msgs::msg::KBall>()
{
  return "amp_msgs/msg/KBall";
}

template<>
struct has_fixed_size<amp_msgs::msg::KBall>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<amp_msgs::msg::KBall>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<amp_msgs::msg::KBall>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AMP_MSGS__MSG__DETAIL__K_BALL__TRAITS_HPP_
