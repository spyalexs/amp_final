...
void DynamicObject::tic(V12d control, double current_time){
    ...
    current_full_state[3] = current_eul[0];
    current_full_state[4] = current_eul[1];
    current_full_state[5] = current_eul[2];
    ...
    updated_or = Eigen::AngleAxisd(current_full_state[5] + d_state[5], Eigen::Vector3d::UnitZ()) *
        Eigen::AngleAxisd(current_full_state[4] + d_state[4], Eigen::Vector3d::UnitY()) *
        Eigen::AngleAxisd(current_full_state[3] + d_state[3], Eigen::Vector3d::UnitX());
