...
bool amp_msgs__msg__set_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amp_msgs.msg._set_pose.SetPose", full_classname_dest, 30) == 0);
  }
  amp_msgs__msg__SetPose * ros_message = _ros_message;
  {  // x_pos
...
{
  /* NOTE(esteve): Call constructor of SetPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amp_msgs.msg._set_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetPose");
