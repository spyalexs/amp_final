...
#include "amp_msgs/msg/detail/launch_ball__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amp_msgs::msg::LaunchBall & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amp_msgs::msg::LaunchBall & ros_message)
{
  // Member: ball_velocity
  cdr >> ros_message.ball_velocity;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amp_msgs
max_serialized_size_LaunchBall(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const amp_msgs::msg::LaunchBall *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amp_msgs::msg::LaunchBall *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaunchBall__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const amp_msgs::msg::LaunchBall *>(
...
static size_t _LaunchBall__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LaunchBall(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LaunchBall__callbacks = {
  "amp_msgs::msg",
  "LaunchBall",
...
static rosidl_message_type_support_t _LaunchBall__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaunchBall__callbacks,
...
{
  return &amp_msgs::msg::typesupport_fastrtps_cpp::_LaunchBall__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amp_msgs, msg, LaunchBall)() {
  return &amp_msgs::msg::typesupport_fastrtps_cpp::_LaunchBall__handle;
}
