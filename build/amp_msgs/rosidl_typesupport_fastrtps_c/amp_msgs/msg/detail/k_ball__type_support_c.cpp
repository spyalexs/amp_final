...
#include "amp_msgs/msg/detail/k_ball__rosidl_typesupport_fastrtps_c.h"
...
using _KBall__ros_msg_type = amp_msgs__msg__KBall;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _KBall__ros_msg_type * ros_message = static_cast<const _KBall__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _KBall__ros_msg_type * ros_message = static_cast<_KBall__ros_msg_type *>(untyped_ros_message);
  // Field name: ball_velocity
  {
    cdr >> ros_message->ball_velocity;
  }
...
size_t get_serialized_size_amp_msgs__msg__KBall(
  const void * untyped_ros_message,
...
static uint32_t _KBall__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amp_msgs__msg__KBall(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amp_msgs
size_t max_serialized_size_amp_msgs__msg__KBall(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amp_msgs__msg__KBall;
    is_plain =
      (
...
static size_t _KBall__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amp_msgs__msg__KBall(
...
static message_type_support_callbacks_t __callbacks_KBall = {
  "amp_msgs::msg",
  "KBall",
...
static rosidl_message_type_support_t _KBall__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amp_msgs, msg, KBall)() {
  return &_KBall__type_support;
}
